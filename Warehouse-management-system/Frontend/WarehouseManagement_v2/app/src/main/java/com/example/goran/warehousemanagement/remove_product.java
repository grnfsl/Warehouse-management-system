...
public class remove_product extends AppCompatActivity implements View.OnClickListener {

    DatabaseHelper db;

    private String accessToken;
    final static private String operation = "remove";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remove_product_activity);
    ...
    private void submit(){
        ...
        if(isAdded)
            Toast.makeText(this, "Product remove added successfully", Toast.LENGTH_LONG).show();
        else
            Toast.makeText(this, "Product remove add failed", Toast.LENGTH_LONG).show();
//        boolean isRemoved = db.markRemove(userInfo, "delta_products");
//
//        if(isRemoved)
//            Toast.makeText(this, "Product removed successfully", Toast.LENGTH_LONG).show();
//        else
//            Toast.makeText(this, "Product remove failed", Toast.LENGTH_LONG).show();
