...
public class increase_product extends AppCompatActivity implements View.OnClickListener {

    DatabaseHelper db;

    private String accessToken;
    final static private String operation = "increase";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.increase_product_activity);
        ...
        findViewById(R.id.increaseB).setOnClickListener(this);
    }
    ...
    private void submit(){
        ...
        if(isAdded)
            Toast.makeText(this, "Product increase added successfully", Toast.LENGTH_LONG).show();
        else
            Toast.makeText(this, "Product increase add failed", Toast.LENGTH_LONG).show();
//        boolean isUpdated = db.updateData(userInfo, "delta_products", "inc");
//
//        if(isUpdated)
//            Toast.makeText(this, "Product increased successfully", Toast.LENGTH_LONG).show();
//        else
//            Toast.makeText(this, "Product increase failed", Toast.LENGTH_LONG).show();
